...
class GameManager:
    ...
    def PrintTutorial(self):
        ...
        print("Rules:")
        print(f"1) Match the cards: Players take turns to play a card from their deck that matches the top card of the discard pile by color or number.") 
        ...
        print(f"3) Draw if no match: Draw a card from the draw pile if you can't play a matching card; play if possible, otherwise draw again and skip turn.")
        print(f"4) Win by playing all cards: The first player to get rid of all their cards wins the game\n")
        print(f"Cards' Symbols:")
        ...
        print("How to play the cards:")
        print(f"1) Normal Card {self._AllCards[30]} : You match either the colour or the number with the card on discard pile, otherwise can't be played.")
        print(f"2) Skip Card {self._AllCards[84]} : You match only with the colour. Skips the other player's turn.")
        print(f"3) Reverse Card {self._AllCards[82]} : You match only with the colour. Reverses the turns which results in the same action as the skip card as this a 2 player game.")
        print(f"4) Draw 2 Card {self._AllCards[96]} : You match only with the colour. Makes opponent draw 2 cards and skips their turn.")
